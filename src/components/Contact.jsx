...
const Contact = () => {
  ...
  return (
    <div id="Join_Us" className='relative text-center p-6 py-20 lg:px-32 w-full overflow-hidden' style={{ backgroundImage: `url(${assets.connect_img})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      {/* Black Tint Overlay */}
