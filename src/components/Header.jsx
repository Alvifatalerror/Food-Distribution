  ...
  return (
    <div className="min-h-screen w-full overflow-hidden relative" id="Header">
      ...
      <div className="relative z-10">
        <Navbar />
        {/* <div className="z-50 absolute inset-0 flex mt-20 justify-end mr-57">
          <SignIn />
        </div> */}
        ...
        <div className="container mx-auto py-4 px-6 md:px-20 lg:px-32 text-white flex items-center min-h-screen">
          <div className="bg-transparent p-10 rounded-lg max-w-lg text-left">
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-semibold pt-10">
              ...
              <span className="inline-block animate-none text-red-500">
                FEED
              </span>
              <span className="inline-block animate-pulse">THE NEED</span>
            </h2>
            <p className="mt-6 text-lg italic">
              "Every day, food is wasted while many go hungry. Together, we can
              change that. Whether giving or receiving, you’re part of a
              movement that ensures no meal is wasted and no one is left
              behind."
            </p>
            <div className="space-x-6 mt-10 flex">
              <a
                href="#Join_Us"
                className="bg-red-500 px-8 py-3 rounded font-bold text-white hover:bg-red-600"
              >
                Talk To Us
              </a>
              <a
