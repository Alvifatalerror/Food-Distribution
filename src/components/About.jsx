...
const About = () => {
  return (
    <div className='flex flex-col items-center justify-center container mx-auto p-14 md:px-20 lg:px-32 w-full overflow-hidden' id='About'>
        ...
        <p className='text-gray-500 max-w-80 text-center mb-8'>No More Wasted Meals. No More Hungry Hearts❤️</p>
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20'>
            ...
            <div className='flex flex-col items-center md:items-start mt-10 text-gray-600'>
                ...
                <p className='my-10 max-w-lg '>Lorem ipsum dolor, sit amet consectetur adipisicing elit. 
                    Eligendi qui facere eaque harum. Quas exercitationem fugit nisi, doloribus molestias aliquam provident 
                    dolorem hic dolorum soluta in. Excepturi quas tenetur aspernatur.</p>
